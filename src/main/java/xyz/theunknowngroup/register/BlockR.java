...
public class BlockR {
    public static <T extends Block> T registerBlock(String modId, String name, Function<BlockBehaviour.Properties, T> fac, BlockBehaviour.Properties block, Item.Properties item) {
